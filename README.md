...
A test/demo setup for Observability Kit using **Vaadin 25.2.6** and **Spring Boot 4.1.1** (Java 21), with **Observability Kit 4.1.1**. For the Grafana part, this project references (as a submodule) the project: https://github.com/petrixh/observability-grafana-setup
